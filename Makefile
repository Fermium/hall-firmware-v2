...
#----------------------------------------------------------------------------
# This makefile is for the hall-effect-v2 project by Fermium LABS srl.
# Copyright 2017
#
# This makefile was originally taken from the usb keyboard project at pjrc
...
# List C++ source files here. (C dependencies are automatically generated.)
CPPSRC = src/main.cpp src/lib/adc/ads1115.cpp src/lib/scheduler/scheduler.cpp src/lib/heater/heater.cpp src/lib/commands/commands.cpp
